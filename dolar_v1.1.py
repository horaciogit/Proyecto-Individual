...
dolars= dolars[dolars.d > datetime.now() - timedelta(days=365) ]
...
ax.set_title('Dolar oficial, blue, volatilidad blue ',  fontsize=14, fontweight='bold')
...
def regressor_plots(money):
    ...
    #-----graficos------------
    plt.title('regresion polinomica ' + title)
